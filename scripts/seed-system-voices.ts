...
// giving path of system voices directory
...
// parse the 5 variables from process.env, Zod strips away any other junk variables
const env = envSchema.parse(process.env);

// Prisma client instance to communicate with the database
...
// if already present update else newly   create.
